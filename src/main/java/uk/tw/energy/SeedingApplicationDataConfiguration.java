...
public class SeedingApplicationDataConfiguration {
    ...
    @Bean
    public Map<String, List<ElectricityReading>> perMeterElectricityReadings() { // Generates Reading based on that.
    ...
    @Bean
    public Map<String, String> smartMeterToPricePlanAccounts() { // Collects Mock Readings.
